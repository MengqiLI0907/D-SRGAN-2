...
for epoch in range(num_epochs):
    ...
    if (epoch + 1) % 50 == 0:
        ...
        # Optionally log the models to W&B
        wandb.save(f"generator_epoch_{epoch + 1}.pth")
        wandb.save(f"discriminator_epoch_{epoch + 1}.pth")

# Save the final model weights
torch.save(generator.state_dict(), "generator_final.pth")
torch.save(discriminator.state_id, "discriminator_final.pth")
wandb.save("generator_final.pth")
wandb.save("discriminator_final.pth")
